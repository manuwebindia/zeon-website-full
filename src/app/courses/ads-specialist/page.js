          ...
          <div className={INNER_PAGE.heroContent}>
            <div className={`${INNER_PAGE.heroInner} animate-fade-in-up`}>
              <nav className={INNER_PAGE.breadcrumb}>
                ...
                <span className={INNER_PAGE.breadcrumbSep}>/</span>
                <span className={INNER_PAGE.breadcrumbCurrent}>Ad Specialist Course</span>
              </nav>

              <h1 className={INNER_PAGE.title}>
                <span className="text-primary">Ad Specialist</span><br /> Course
              </h1>
              ...
              <div className="w-full lg:w-1/3 lg:max-w-[400px]">
                <div className="h-full space-y-8">
                  ...
                  <div className="bg-white border border-border rounded-2xl p-6 shadow-card hover:shadow-card-hover transition-all">
                    ...
                    <CourseShareActions
                      courseName="Google & Meta Ads Specialist Course"
                      courseSlug="ads-specialist"
                    />
                  </div>
